...
echo.
start "FMC SQL Sync Worker" powershell.exe -NoExit -NoProfile -ExecutionPolicy Bypass -File "%~dp0scripts\Start-DataverseSync.ps1" -Mode Run
start "FMC SharePoint Sync Worker" powershell.exe -NoExit -NoProfile -ExecutionPolicy Bypass -File "%~dp0scripts\Start-SpoDataverseWatch.ps1"
