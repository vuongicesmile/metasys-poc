// Generated by npm run build. Edit src/; do not edit this file directly.
import { type cr3c8_silvernewbmspoint, type fmc_bmsbuilding, type fmc_bmsequipment, type fmc_bmspoint, type fmc_bmsreading, type fmc_spochangerequest, type fmc_spofile, type fmc_spoimportrow, type fmc_syncrequest, type GeneratedComponentProps, type ReadableTableRow } from "./RuntimeTypes";
import { Badge, Button, Card, createTableColumn, DataGrid, DataGridBody, DataGridCell, DataGridHeader, DataGridHeaderCell, DataGridRow, makeStyles, SearchBox, Select, Spinner, TableCellLayout, Text, tokens } from "@fluentui/react-components";
import { AddRegular, ArrowClockwiseRegular, ArrowDownRegular, ArrowSyncRegular, BuildingRegular, ChatRegular, CheckmarkCircleRegular, ChevronRightRegular, ClockRegular, DatabaseRegular, DesktopRegular, FolderRegular, OpenRegular, PersonRegular, PulseRegular, SearchRegular, TableRegular } from "@fluentui/react-icons";
...
type ReadableSpoChangeRequest = ReadableTableRow<fmc_spochangerequest>;
...
// Source: src/services/dashboardService.ts
...
// Source: src/services/navigationService.ts
type NavigationApi = {
    Navigation?: {
...
// Source: src/services/agentChatService.ts
...
async function openAgentChat(): Promise<"opened" | "unavailable"> {
...
// Source: src/services/spoChangeService.ts
const SPO_CHANGE_PENDING = 789112000;

const SPO_CHANGE_LIMIT = 3;

async function queryPendingSpoChanges(dataApi: GeneratedComponentProps["dataApi"]): Promise<ReadableSpoChangeRequest[]> {
...
function canClaimSpoChanges(): boolean {
...
async function claimSpoChange(request: ReadableSpoChangeRequest): Promise<void> {
...
// Source: src/components/SpoChangeBanner.tsx
type Props = {
...
function SpoChangeBanner({ items, now, claimingId, error, language, canClaim, onClaim, onViewAll, styles }: Props) {
    const t = (text: string) => translate(text, language);
