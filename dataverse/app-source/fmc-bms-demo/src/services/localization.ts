...
export const englishMessages: Record<string, string> = {
    ...
    "Agent chưa được kết nối với ứng dụng. Nếu Microsoft 365 Copilot đã bật, bạn có thể mở khung chat của Power Apps.": "The agent is not connected to this app yet. If Microsoft 365 Copilot is enabled, you can open the Power Apps chat pane.",
    "Mở khung chat": "Open chat pane",
    "Bắt đầu": "Started",
    ...
    "Copilot chat chưa được bật hoặc chưa khả dụng cho tài khoản này trong Power Apps.": "Copilot chat is not enabled or available for this account in Power Apps.",
    ...
    "Đang mở Copilot chat": "Opening Copilot chat",
    ...
    "Không thể mở Copilot chat. Hãy thử lại hoặc kiểm tra cấu hình Agent trong app.": "Could not open Copilot chat. Try again or check the app's Agent configuration.",
    ...
    "Mở Copilot chat": "Open Copilot chat",
